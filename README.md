...
- Stack
  - `Screen` LCD, TFT, OLED, HMI
  - `UAV` Quadcopter
  - `Sensor` MLX90640, IR, MQ Sensor, Ultrasonic Sensor
- SoC/MCU/DSP
  - `ST` STM32 F0/F1/F3/F4/F7/H7/L0/L1/L4
  - `Nordic` NRF52832 BLE5.0 NRF52832 BLE5.1
  - `ESP` ESP8266, ESP32
  - `MicrpChip` AVR IoT Board
- IDE
  - `VS Code`, `VS 2019`,`LabView`, `IDA 7.5`,`Android Studio` `STM32CubeIDE`
- EDA
  - `EasyEDA`
  - `Eagle`
  - `Proteus`
